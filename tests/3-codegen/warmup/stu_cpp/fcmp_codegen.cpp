...
void translate_main(CodeGen *codegen) {
    ...
    codegen->append_inst("addi.d $t0, $zero, 0");
    ...
    // 间中
    offset_map["%op1"] = offset_map["%op0"] - 4; // TODO: 请填空
    ...
    codegen->append_inst("ld.w",
                         {"$t0", "$fp", std::to_string(offset_map["%op1"])});
    codegen->append_inst("and",
                         {"$t1", "$t0", "$zero"});
    codegen->append_inst("slt",
                         {"$t2", "$t0", "$t1"});
    codegen->append_inst("slt",
                         {"$t3", "$t1", "$t0"});
    codegen->append_inst("or",
                         {"$t0", "$t2", "$t3"});
    codegen->append_inst("st.w",
